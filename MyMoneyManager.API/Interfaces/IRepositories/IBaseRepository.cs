...
//namespace MyMoneyManager.API.Interfaces.IRepositories;

//public interface IBaseRepository<T> where T : class
//{
//    Task<IEnumerable<T>> GetAll(CancellationToken cancellationToken);
//    Task<IEnumerable<T>> GetAll(List<Expression<Func<T, bool>>> includeExpressions, CancellationToken cancellationToken = default);
...
//    Task<T> GetById<Tid>(List<Expression<Func<T, bool>>> includeExpressions, Tid id, CancellationToken cancellationToken);
